...
describe GlobalExcelReader do
  ...
  describe '#convert_csv' do
    it 'reads a csv file into a hash of {[sheet name] => [data]}' do
      subject_csv.to_hash.must_equal([[" Animal Network Project Claim Form",
  nil,
  nil,
  nil,
  nil,
 ...
 ["Name of Animal Network:",
  ...
  nil,
  nil],
 ["Project Name:", "2", nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil],
 ["Project Type", nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil],
 ["Contract start date:",
  "2015-06-01",
  nil,
  nil,
 ...
 ["Woot", nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil],
 ["75%", nil, " - ", nil, " - ", " - ", " - ", nil, nil, nil, nil, nil, nil, nil, nil, nil, nil],
 [nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil],
 ["Yo", nil, " $- ", nil, " $- ", " $- ", " $- ", nil, nil, nil, nil, nil, nil, nil, nil, nil, nil],
 [nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil],
